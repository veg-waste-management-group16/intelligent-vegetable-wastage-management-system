...
const FarmerDashboard = () => {
    ...
    useEffect(() => {
        ...
        const parsedUser = loggedUserStr ? JSON.parse(loggedUserStr) : {};
        const resolvedFarmerId = parsedUser?.farmerId || parsedUser?.farmerIndex || 'F001';
        setFarmerId(resolvedFarmerId);
        setFarmerName(parsedUser?.name || resolvedFarmerId);
    ...
    return (
        <main className="main-content dashboard-page" style={{padding: "28px 28px 40px", maxWidth: "100%"}}>
