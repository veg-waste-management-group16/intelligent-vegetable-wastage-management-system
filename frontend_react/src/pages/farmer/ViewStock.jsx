...
import { API_BASE_URL } from '../../api/farmerConfig'; // Added this import
...
function ViewStock() {
  ...
  const [farmerId] = useState(() => { try { const u = JSON.parse(sessionStorage.getItem('loggedUser')||'{}'); return u.farmerId || u.farmerIndex || 'F001'; } catch { return 'F001'; } });
