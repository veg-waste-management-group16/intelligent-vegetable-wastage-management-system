    ...
    >
      ...
      {user.lastUpdateNote && (
        <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center',
          padding:'10px 0', borderBottom:'1px solid #f0f0f0', marginTop:4 }}>
          <span className="profile-info-label">Last Profile Update</span>
          <span style={{ fontSize:'0.82rem', fontWeight:600, color:'#e67e22',
            background:'#fff3e0', padding:'3px 10px', borderRadius:20,
            border:'1px solid #ffd080', display:'flex', alignItems:'center', gap:5 }}>
      ...
      {isFarmer && <>
        ...
        <Row label="Cultivated Area" value={user.cultivatedAreaHectares != null ? `${user.cultivatedAreaHectares} ha` : null} />
        <div className="profile-info-row">
